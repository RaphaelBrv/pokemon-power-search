...
export const PokeballLampContainer = ({
  children,
  className,
}: {
  children: React.ReactNode;
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <div className="absolute inset-auto z-10 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-red-500 opacity-30 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          whileInView={{ width: "16rem" }}
          transition={{
          ...
          className="absolute inset-auto z-10 h-36 w-64 -translate-y-[6rem] rounded-full bg-red-400 blur-2xl opacity-30"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          whileInView={{ width: "30rem" }}
          ...
          className="absolute inset-auto z-10 h-0.5 w-[30rem] -translate-y-[7rem] bg-red-400 opacity-40"
        ></motion.div>

        <div className="absolute inset-auto z-10 h-44 w-full -translate-y-[12.5rem] bg-transparent"></div>
      </div>
